...
contract KittyCore is KittyMinting {
    ...
    returns (
        ...
        KittyModel.Kitty storage kit = kitties.get(_id);
        ...
        siringWithId = bytes32(kit.siringWithId);
        birthTime = uint256(kit.birthTime);
        matronId = bytes32(kit.matronId);
        sireId = bytes32(kit.sireId);
