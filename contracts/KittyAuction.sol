...
contract KittyAuction is KittyBreeding {
    ...
    whenNotPaused
    {
        require(stringEq(symbol, sero_msg_category()));
        bytes32 _kittyId = sero_msg_ticket();
    ...
    {
        require(stringEq(symbol, sero_msg_category()));
        //ID of the matron owned by the bidder. get from tx params
        ...
        _breedWith(bytes32(_matronId), bytes32(_sireId));
